...
df_noticias = pd.read_csv(
    glob.glob("C:/Users/valdeci.neto/Downloads/pop_rua_20260414_161152.csv")[0],
    sep=None, engine='python', encoding='latin-1', on_bad_lines='skip'
)

df_obitos = pd.read_csv(
    glob.glob("C:/Users/valdeci.neto/Downloads/pop_rua_Obito_20260416_135223.csv")[0],
